...
export async function saveWorkspaceConfig(
  ...
  const CONFIG_HEADER =
    "Segment Typewriter Configuration (https://segment.com/docs/protocols/typewriter)\nJust run `npx https://github.com/mindvalley/segmentio-typewriter/releases/latest/download/typewriter.tgz` to re-generate a client with the latest versions of these events.";
