    ...
    if (error instanceof RequestError) {
      if (error instanceof HTTPError) {
        throw wrapError(
          ...
          "Verify you are using the right API token by running 'npx https://github.com/mindvalley/segmentio-typewriter/releases/latest/download/typewriter.tgz tokens'"
        );
