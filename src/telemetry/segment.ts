...
//   npx https://github.com/mindvalley/segmentio-typewriter/releases/latest/download/typewriter.tgz
    ...
    return () => {
      console.warn(`⚠️  You made an analytics call (${String(
        method
         ...
         a) Re-generate your typewriter client: \`npx https://github.com/mindvalley/segmentio-typewriter/releases/latest/download/typewriter.tgz\`
