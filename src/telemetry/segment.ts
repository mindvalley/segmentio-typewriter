...
//   npx https://github.com/segmentio/typewriter/releases/latest/download/typewriter.tgz
...
export default new Proxy<typeof clientAPI>(clientAPI, {
    get(target, method) {
        ...
        return () => {
         ...
         a) Re-generate your typewriter client: \`npx https://github.com/segmentio/typewriter/releases/latest/download/typewriter.tgz\`
